...
Ant::Ant() {
  this->position = Point2di(5, 5);  // Posicion de la hormiga en el (5,5) (hormiga 1 simple)
}
...
void Ant::setModifiedAnt(bool valor) {
  ModifiedAnt = valor;
}

bool Ant::getModifiedAnt() {
  return ModifiedAnt;
}

void Ant::Move(World* context) {  // Poliformismo dinámico + puntero
  bool stop = false;
