      ...
      if (std::cin.fail()) {
        ...
        switch (menu_option) {
          ...
          case 1:
            ...
            std::cout << "\n=> La clave " << (table.insert(dni) ? " se ha insertado correctamente!" : " NO se ha insertado") << std::endl;
          ...
          case 2:
            ...
            std::cout << "\n=> La clave " << (table.search(dni) ? " se ha encontrado!" : " NO se ha encontrado") << std::endl;
            std::cin.ignore();  // Ignorar el carácter de nueva línea en el buffer
            break;
          case 3:
            table.print();
